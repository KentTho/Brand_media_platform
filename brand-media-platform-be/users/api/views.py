...
from users.api.response import (
    success_response,
    error_response,
)  # Assume shared response.py in project or copy
    ...
    def post(self, request):
        ...
        if not serializer.is_valid():
            return error_response(
                _("Registration failed"), serializer.errors, status.HTTP_400_BAD_REQUEST
            )
        ...
        return success_response(
            data, _("User registered successfully"), status.HTTP_201_CREATED
        )
