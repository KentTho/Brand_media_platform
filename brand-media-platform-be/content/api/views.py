...
class ArticleListAPIView(ListAPIView):
    ...
    def get_queryset(self):
        ...
        queryset = (
            Article.objects.filter(status="published", deleted_at__isnull=True)
        ...
        switch_language(
            self.request, lang
        )  # Why: Parler-safe context switch; better than translation.activate for fallback
...
class ArticleDetailAPIView(RetrieveAPIView):
    ...
    def get_queryset(self):
        ...
        ).prefetch_related("related_products", "tags", "topics")
    ...
    def retrieve(self, request, *args, **kwargs):
        try:
            ...
            return success_response(
                response.data, _("Article detail fetched successfully")
            )
