...
class ProductListSerializer(TranslatableModelSerializer):
    ...
    class Meta:
        model = Product
        fields = (
            'id', 'slug', 'name', 'image', 'is_featured', 'material'
        )
...
class ProductDetailSerializer(TranslatableModelSerializer):
    ...
    class Meta:
        model = Product
        fields = (
            'id', 'slug', 'name', 'story', 'description', 'specifications',
            'image', 'external_link', 'is_featured', 'material',
            'related_articles', 'created_at'
        )