...
@method_decorator(vary_on_headers('Accept-Language'), name='dispatch')  # Cache riêng theo lang
class ProductListAPIView(ListAPIView):
    serializer_class = ProductListSerializer
    pagination_class = StandardResultsSetPagination  # Optional – you can remove if want manual count
...
class ProductDetailAPIView(RetrieveAPIView):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        try:
            ...
            return success_response({"data": serializer.data}, _("Product detail fetched successfully"))
